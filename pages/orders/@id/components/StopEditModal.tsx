            ...
            {isOpen && (
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-[32px] shadow-2xl overflow-hidden border border-gray-100 dark:border-slate-800 flex flex-col max-h-[90vh]"
                    >
                        {/* Header */}
                        <div className="p-6 border-b border-gray-50 dark:border-slate-800 flex items-center justify-between bg-white dark:bg-slate-900 sticky top-0 z-10">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-xl font-black text-gray-900 dark:text-slate-100">Modifier le passage</h3>
                                    <p className="text-sm text-gray-400 dark:text-slate-500 font-medium font-mono uppercase">{editedStop.id}</p>
                                </div>
                            </div>
                            <button
                                onClick={onClose}
                                className="p-2 hover:bg-gray-50 dark:hover:bg-slate-800 rounded-xl text-gray-400 dark:text-slate-500 transition-colors"
                            >
                                <X size={20} />
                            </button>
                        </div>
                            ...
                            <section>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="col-span-2">
                                        <label className="text-[10px] font-black text-gray-500 dark:text-slate-400 uppercase ml-1 mb-1 block">Rue</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="text-[10px] font-black text-gray-500 dark:text-slate-400 uppercase ml-1 mb-1 block">Ville</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="text-[10px] font-black text-gray-500 dark:text-slate-400 uppercase ml-1 mb-1 block">État / Province</label>
                                        <input
                                            type="text"
                                    ...
                                    {editedStop.actions.map((action: any, idx: number) => (
                                        <div key={action.id} className="p-4 bg-gray-50 dark:bg-slate-800/50 rounded-2xl border border-gray-100 dark:border-slate-800 flex items-start justify-between">
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <div className="text-sm font-black text-gray-900 dark:text-slate-100">{action.product.name}</div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="px-3 py-1 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-full text-[10px] font-black text-gray-400 dark:text-slate-500 uppercase tracking-tighter">
                                                    {action.status}
                                                </span>
                                            </div>
                                        </div>
                        ...
                        {/* Footer */}
                        <div className="p-6 border-t border-gray-50 dark:border-slate-800 bg-white dark:bg-slate-900 flex gap-4">
                            <button
                                onClick={onClose}
                                className="flex-1 px-6 py-3.5 bg-gray-50 dark:bg-slate-800 hover:bg-gray-100 dark:hover:bg-slate-700 text-gray-700 dark:text-slate-300 rounded-2xl font-black text-xs uppercase tracking-widest transition-all"
                            >
                                Annuler
                            </button>
                            <button
