            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                    ...
                    <h2 className="text-xl tracking-tight font-bold text-gray-900">
                        {newItemForm.name || 'Nouveau Produit'}
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide p-6 space-y-8">
            ...
            <section>
                ...
                <EditableField
                    ...
                    onChange={(val) => setNewItemForm({ ...newItemForm, name: val })}
                />
            </section>
                ...
                <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <EditableField
                            ...
                            type="number"
                            placeholder="0"
                            onChange={(val) => setNewItemForm({ ...newItemForm, weight_g: Number(val) })}
                        />
                        <EditableField
                            label="Unitary Price (€)"
                            ...
                            type="number"
                            placeholder="0"
                            onChange={(val) => setNewItemForm({ ...newItemForm, unitary_price: Number(val) })}
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex gap-2">
                            <button
                                onClick={() => setNewItemForm({ ...newItemForm, packaging_type: 'box' })}
                            ...
                            <button
                                onClick={() => setNewItemForm({ ...newItemForm, packaging_type: 'fluid' })}
            ...
            <section>
                ...
                <div className="grid grid-cols-3 gap-3">
                    <EditableField
                        ...
                        type="number"
                        placeholder="0"
                        onChange={(val) => setNewItemForm({
                            ...newItemForm,
                            dimensions: { ...newItemForm.dimensions, width_cm: Number(val) }
                        })}
                    />
                    <EditableField
                        label="H"
                        ...
                        onChange={(val) => setNewItemForm({
                            ...newItemForm,
                            dimensions: { ...newItemForm.dimensions, height_cm: Number(val) }
                        })}
                    />
                    <EditableField
                        label="D"
                        ...
                        onChange={(val) => setNewItemForm({
                            ...newItemForm,
                            dimensions: { ...newItemForm.dimensions, depth_cm: Number(val) }
                        })}
                    />
                </div>
            </section>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    const newReqs = isSelected
                                        ? newItemForm.requirements.filter((r) => r !== req.id)
                                        : [...newItemForm.requirements, req.id];
